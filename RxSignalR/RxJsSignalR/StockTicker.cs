namespace RxJsSignalR
{
    ...
    public class StockTicker
    {
        ...
        private StockTicker(IHubConnectionContext<dynamic> clients)
        {
            ...
            _timer = new Timer(this.UpdateStockPrices, null, this._updateInterval, this._updateInterval);
        ...
        private void UpdateStockPrices(object state)
        {
            lock (this._updateStockPricesLock)
            {
                if (!this._updatingStockPrices)
                {
                    ...
                    foreach (var stock in this._stocks.Values)
                    {
                        if (this.TryUpdateStockPrice(stock))
                        {
                            this.BroadcastStockPrice(stock);
                        }
                    }
